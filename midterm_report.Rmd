...
# Severity and Treatment Type

## Graph 1: Comparing pneumonia and pregnancy data

```{r, graph1}
knitr::include_graphics(here::here("output/pneumonia_vs_pregnancy.png"))
```

## Death Status by COVID-19 Severity Classification
```{r, graph2}
knitr::include_graphics(here::here("output/death_status_by_severity.png"))
```

## Severity Classification by Asthma and Diabetes
```{r, graph3}
knitr::include_graphics(here::here("output/severity_by_asthma_diabetes.png"))
```

## Classification of COVID-19 Cases (Pie Chart)
```{r, graph4}
knitr::include_graphics(here::here("output/classification_pie_chart.png"))
```

# Outcome and Mortality Analysis

## Summary of ICU Admission, Intubation, and Mortality Rates
```{r, mortality1}
summary_table <- readRDS(here::here("output", "summary_table.rds"))
kable(summary_table, caption = "Summary of ICU Admission, Intubation, and Mortality Rates")
```

## Mortality Rate by Pregnancy Status

```{r, mortality2}
knitr::include_graphics(here::here("output", "mortality_by_pregnancy.png"))
```
